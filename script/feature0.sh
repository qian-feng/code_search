#!/bin/bash
sample_dir="/home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb/*"
echo $sample_dir
cd /home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb
rm /home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb/*.id0
rm /home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb/*.id1
rm /home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb/*.til
rm /home/qian/code_search/crossarch/idb/coreutil_i386_o0_idb/*.nam
for file in $sample_dir
do
	mkdir /home/qian/data/mcsema/IR/dug0
	mkdir /home/qian/data/mcsema/IR/seq0
	...
	opt -load /home/qian/code_search/mcsema-master/build/Hello0/libLLVMHello0.so -mem2reg -dce -die -dse -memcpyopt -loop-simplify -indvars  -constmerge -constprop -instcombine -hello0 < /home/qian/data/mcsema/$filename".bc" > /dev/null
