...
private:
  ...
  bool linkNeighbors(const BasicBlock *BB) {
  ...
  bool generateCFG(Function &F){
      ...
      bool success = linkNeighbors(entryBB);
      if (success) {
  ...
  bool generateDUchin(Function &F){
      ...
      std::string path = "/home/qian/data/mcsema/IR/dug/" + fname + ".index";
      //std::string path = "/home/qian/" + fname + ".index";
      ...
      std::string dir = "/home/qian/data/mcsema/IR/seq/";
      //std::string dir = "/home/qian/";
  ...
  void dumpDUG(Function &f){
      std::string fname = f.getName();
      std::string path = "/home/qian/data/mcsema/IR/dug/" + fname + ".gml";
      //std::string path = "/home/qian/" + fname + ".gml";
